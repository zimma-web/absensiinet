...
@section('content')
        ...
        <div id="user-detail">
            <div class="avatar">
                @if (!empty(Auth::guard('karyawan')->user()->foto))
                    @php
                        $path = Storage::url('uploads/foto/' . Auth::guard('karyawan')->user()->foto);
                    @endphp
    ...
    <div class="section mt-2" id="presence-section">
                            ...
                            <div class="presencecontent">
                                <div class="iconpresence">
                                    @if ($presensihariini != null)
                                        @php
                                            $path = Storage::url('uploads/absensi/' . $presensihariini->poto_in);
                                        @endphp
                            ...
                            <div class="presencecontent">
                                <div class="iconpresence">
                                    @if ($presensihariini != null && $presensihariini->jam_out != null)
                                        @php
                                            $path = Storage::url('uploads/absensi/' . $presensihariini->poto_out);
                                        @endphp
                                        <img src="{{ url($path) }}" alt="" class="imaged w64">
                                    @else
                                        <ion-icon name="person-circle"></ion-icon>
        ...
        <div id="rekappresensi">
            <h3> Rekap Absensi Bulan {{ $namabulanini }} Tahun {{ $tahunini }} </h3>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top:3px; right: 5px; font-size: 0.6rem; z-index: 999;">12</span>
